...
public class GameManager : MonoBehaviour, IInitializable
{
    ...
    private void SetupEventHandlers()
    {
        ...
        _signalBus.Subscribe<StartGameSignal>(OnStartGameRequested);
    ...
    {
        Debug.Log($"GameManager: Game ended - {signal.Result.WinnerName} won");
    ...
    private void OnDestroy()
    {
        ...
        if (_signalBus != null)
        {
            _signalBus.TryUnsubscribe<StartGameSignal>(OnStartGameRequested);
